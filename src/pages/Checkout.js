...
function Checkout() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5 my-20">
        ...
        <div className="lg:col-span-2">
          {/* <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 bg-white pt-5 mt-24 ">
